...
<iframe src="https://huggingface.co/spaces/your-name/audio-denoising?embed=true" width="850" height="460" frameborder="0"></iframe>

*(Replace the URL once deployed. GitHub README shows a blank frame, but GitHub Pages will render it.)*

### Interactive results plot

<iframe src="results/figures/si_sdr.html" width="700" height="400"></iframe>

The HTML is generated by running `plot_results.py --interactive` (optional Plotly version).
